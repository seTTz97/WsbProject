...
import pl.wsb.targowicz.sprites.Bird;
import pl.wsb.targowicz.sprites.Tube;

public class PlayState extends State {
    private static final int GROUND_Y_OFFSET = -30; // floor
    private static final int TUBE_SPACING = 125;  // distance between tubes
